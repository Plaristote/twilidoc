...
def twilart
  ...
  glasses     = Shell.get_str_color([{color: :blue, type: :background},  {color: :black, type: :color}])
  glas_borders= Shell.get_str_color([{color: :black, type: :background}, {color: :white, type: :color}])
...
````````````#{a}..-..#{r}`````````````````````#{a}-#{r}``#{h}-dyoy#{b}/#:#{h}osoosso/+yhdmd/#{s}---+o#{r}`````````````````````````#{a}./#{r}`````
``````````````#{a}..#{r}`````````````````````#{a}..#{r}```-`#{b}/o#{g}:-+#{b}yy#{s}soo#{b}/--:+ydy+#{s}--+o#/#{a}-#{r}`````````````````````````#{a}/#{r}`````
```````````````#{a}-#{r}```````````````````` #{a}-#{r}.`````#{b}/o:/oo/ooo#{g}/:-/s#{b}yo#{s}++++o#{h}y#{a}.:#{r} ```````````````````````#{a}-:#{r}`````
````````````````#{a}.#{r}````````````````````#{a}-#{r}``````#{a}.:#{s}:-----:#{b}/++++/#{s}-:++++#{h}ds#{r}`#{a}:#{r}```````````````````````#{a}./.#{r}`````
...
``````````````````````````````````````#{Shell.get_reset}Sit tight and enjoy the view#{r}``````````````````````````````````
````````````````````````````````````````````````````````````````````````````````````````````````````
````````````````````````````````````````````````````````````````````````````````````````````````````\n#{Shell.get_reset}"
end
