...
(function() {
  var ATTR_CONST, ATTR_INLINE, ATTR_PTR, ATTR_REF, ATTR_STATIC, ATTR_TYPEDEF, ATTR_UNSIGNED, ATTR_VIRTUAL, AnchorHandle, Attribute, Breadcrumb, Class, ClassList, Foldables, Homepage, Member, Menu, MenuEntry, Project, View, VisibilityHandle, Widget, escape_html,
  ...
  Member = (function(_super) {
    ...
    Member.prototype.RenderMethod = function(method) {
      var html, obj_type, params, typedef, visibility;
      html = '';
